...
meanwhile, CPUs can also have multiple threads running on multiple physical cores. As beneficial
as parallel computing seems, it raises some looming problems caused by desynchronization --
